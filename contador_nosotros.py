...
cap = cv2.VideoCapture("Videos/Video1y2.mp4") #para video
cap.set(3, 1280)
cap.set(4, 720)
...
#video 2
limitsUp = [500, 540, 735, 540]
limitsDown = [527, 500, 735, 500]

#limites video 1
limitsUp = [100, 540, 335, 540]
limitsDown = [100, 500, 335, 500]
...
# Diccionarios para registrar cruces
crossed_up = {}
crossed_down = {}
